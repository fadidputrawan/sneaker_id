...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box;font-family:Arial,Helvetica,sans-serif}
        ...
        .btn-edit, .btn-delete{display:inline-block;padding:8px 12px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none;border:none;cursor:pointer}
...
<div class="container">
    ...
    <div class="main">
        ...
        <div class="table-box">
            <h4>Daftar User</h4>
            @if(session('success'))
                <div style="margin-bottom:15px;padding:12px 16px;background:#d1fae5;color:#065f46;border-radius:8px;">{{ session('success') }}</div>
            @endif
            <table>
                <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                <a href="{{ route('admin.user.edit', $u->id) }}" class="btn-edit">Edit</a>
                                <form action="{{ route('admin.user.destroy', $u->id) }}" method="POST" onsubmit="return confirm('Hapus user ini?');" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
