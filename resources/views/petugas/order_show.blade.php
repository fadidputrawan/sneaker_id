                ...
                <div class="detail-item">
                    ...
                    <div class="value">
                        ...
                        @if($order->cancelled_by === 'user')
                            <div style="margin-top:8px;padding:8px 12px;background:#fee2e2;color:#991b1b;border-radius:6px;font-size:13px;font-weight:600;">✕ Dibatalkan oleh User</div>
                        @elseif($order->cancelled_by === 'admin')
                            <div style="margin-top:8px;padding:8px 12px;background:#fef3c7;color:#92400e;border-radius:6px;font-size:13px;font-weight:600;">✕ Dibatalkan oleh Admin</div>
                        @endif
                    </div>
                </div>
                <div class="detail-item">
            ...
            @php
                ...
                if ($order->payment_proof) {
                    ...
                    if (Storage::disk('public')->exists($proofPath)) {
                        $proofUrl = asset('uploads/' . $proofPath);
                    } else {
                        $legacyPath = preg_replace('#^images/#', '', $proofPath);
                        if ($legacyPath !== $proofPath && Storage::disk('public')->exists($legacyPath)) {
                            $proofUrl = asset('uploads/' . $legacyPath);
                        } elseif (str_starts_with($proofPath, 'images/')) {
